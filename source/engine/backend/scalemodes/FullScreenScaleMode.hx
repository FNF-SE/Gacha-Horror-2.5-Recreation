...
/**
 * From Funkin
 * https://github.com/FunkinCrew/Funkin/blob/main/source/funkin/ui/FullScreenScaleMode.hx
 */
class FullScreenScaleMode extends flixel.system.scaleModes.BaseScaleMode
{
	 ...
	 */
	public static var maxAspectRatio:FlxPoint = FlxPoint.get(18, 10);
	...
	{
		if (#if android (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.P || android.Tools.isTablet()) #else true #end)
		{
			enabled = Value;
		}
		else
