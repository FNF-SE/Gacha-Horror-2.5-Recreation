...
class MusicBeatSubstate extends FlxSubState
{
	...
	public function addMobileControls(defaultDrawTarget:Bool = false):Void
	{
		...
		{
			MobileData.buttonsColors[0] = 0xC24B99;
			MobileData.buttonsColors[1] = 0x00FFFF;
			MobileData.buttonsColors[2] = 0x12FA05;
			MobileData.buttonsColors[3] = 0xF9393F;
		}
		else
		{
			MobileData.buttonsColors[0] = MobileData.buttonsColors[2] = 0xFF6699CC;
			MobileData.buttonsColors[1] = MobileData.buttonsColors[3] = 0xFFFF0000;
		}

		// I HATE INTERFACE I HATE INTERFACE I HATE INTERFACE I HATE INTERFACE I HATE INTERFACE I HATE INTERFACE I HATE INTERFACE I HATE INTERFACE I HATE INTERFACE I HATE INTERFACE I HATE INTERFACE
		mobileControls.buttonLeft.color = MobileData.buttonsColors[0];
		mobileControls.buttonDown.color = MobileData.buttonsColors[1];
		mobileControls.buttonUp.color = MobileData.buttonsColors[2];
		mobileControls.buttonRight.color = MobileData.buttonsColors[3];
