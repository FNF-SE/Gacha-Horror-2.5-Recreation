-- by sloow
local scale = 0.8
local ldim = 'tutorial' -- put here your image name (the image must have a size of 1675 x 1083)
local loading = false

function onCreate()
    makeLuaSprite('ld', 'loadingscreen/tutorial', -50, -100) -- creating the image
